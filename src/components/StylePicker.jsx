...
export const LEARNING_STYLES = [
  { id: 'reading-room', name: 'Reading Room', description: 'Soft book covers, expressive titles, and deep green. The original Discover style.' },
