    ...
    return (
      <div className="coding-history learning-overview" style={{ margin: '0 auto' }}>
        <div className="prep-header">
          <span className="learning-eyebrow">PRACTICE JOURNAL</span><h1>Python practice history</h1>
          <p>Review the challenges you’ve generated.</p>
        </div>
        <button className="btn btn-secondary btn-sm" onClick={() => setShowHistory(false)} style={{ marginBottom: 16 }}>← Python practice</button>
  ...
  return (
    <div className="coding-practice" style={{ maxWidth: '100%', margin: '0 auto' }}>
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        <div className="prep-header">
          <span className="learning-eyebrow">PRACTICE & APPLY</span><h1>Python practice</h1>
          <p>Apply the Python topics you’ve studied to a fresh coding challenge.</p>
        </div>
