...
export default function ReadingWorkspace() {
  ...
  useEffect(() => { setOpen(false); heading.current?.focus({ preventScroll: true }); heading.current?.scrollIntoView({ block: 'start' }) }, [sectionId, topic])
